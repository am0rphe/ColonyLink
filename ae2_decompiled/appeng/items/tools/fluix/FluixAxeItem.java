...
implements IntrinsicEnchantItem {
    ...
    public FluixAxeItem(Item.Properties props) {
        super(FluixToolType.FLUIX.getToolTier(), props.attributes(FluixAxeItem.createAttributes((Tier)FluixToolType.FLUIX.getToolTier(), (float)6.0f, (float)-3.1f)));
    }
