...
implements IntrinsicEnchantItem {
    ...
    public FluixHoeItem(Item.Properties props) {
        super(FluixToolType.FLUIX.getToolTier(), props.attributes(FluixHoeItem.createAttributes((Tier)FluixToolType.FLUIX.getToolTier(), (float)-2.0f, (float)-1.0f)));
    }
