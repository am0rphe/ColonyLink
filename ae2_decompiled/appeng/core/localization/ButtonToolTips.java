...
public enum ButtonToolTips implements LocalizationEnum
{
    ...
    InscriberSidenessSeparate("Automation can access slots from specific sides. Top and bottom slots can be extracted from."),
    ...
    private ButtonToolTips(String englishText) {
        this.englishText = englishText;
    }

    @Override
    public String getTranslationKey() {
        return "gui.tooltips.ae2." + this.name();
    }
