...
extends AEBaseMenu {
    ...
    extends OutputSlot {
        ...
        public ItemStack getItem() {
            ...
            if (RestrictedInputSlot.isMetalIngot(input) && !QuartzKnifeMenu.this.currentName.isBlank()) {
                ItemStack namePressStack = AEItems.NAME_PRESS.stack();
                namePressStack.set(AEComponents.NAME_PRESS_NAME, (Object)Component.literal((String)QuartzKnifeMenu.this.currentName));
                ...
                if (!this.getInventory().extractItem(0, 1, false).isEmpty()) {
                    ...
                    item.hurtAndBreak(1, serverPlayer.serverLevel(), serverPlayer, ignored -> {
                        if (QuartzKnifeMenu.this.itemMenuHost.getPlayerInventorySlot() != null) {
                            playerInv.setItem(QuartzKnifeMenu.this.itemMenuHost.getPlayerInventorySlot().intValue(), ItemStack.EMPTY);
                        }
