...
implements IPartModel {
    ...
    public PartModel(boolean isSolid, ResourceLocation resource) {
        this(isSolid, (List<ResourceLocation>)ImmutableList.of((Object)resource));
    }

    public PartModel(boolean isSolid, ResourceLocation ... resources) {
        this(isSolid, (List<ResourceLocation>)ImmutableList.copyOf((Object[])resources));
    }
